...
Veja mais em [Link](https://petstore.swagger.io/#/)

Projeto desenvolvido como parte do desafio técnico da Inter, com o objetivo de automatizar cenários de testes de uma API pública PetStore - [Link](https://petstore.swagger.io/#/).
